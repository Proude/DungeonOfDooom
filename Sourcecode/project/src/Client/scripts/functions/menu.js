...
game.menu.openMatchLobby = function() {
    ...
    game.menu.lobby.css('display','inline-flex');
...
game.menu.matchSelection = function() {
    game.menu.choice.css('display', 'none');
    game.menu.head.css('display', 'none');
    game.menu.match.css('display', 'inline-flex');
}
...
game.menu.initGameScreen = function() {
    ...
    game.menu.game.css('display', 'inline-flex');
...
game.menu.returnToMenu = function() {
    ...
    game.menu.menu.css('display', 'inline-flex');
};

$( document ).ready(function() {
    game.menu.head = $('#homeHeading');
    game.menu.choice = $('#choice');
    game.menu.menu = $('#menu');
    ...
    $('#single-btn').click(game.menu.matchSelection);
